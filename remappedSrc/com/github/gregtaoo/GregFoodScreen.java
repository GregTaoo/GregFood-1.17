...
public class GregFoodScreen {
    public static class UpdateScreen extends Screen {
        ...
        public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
            ...
            drawCenteredText(matrices,this.textRenderer,"Copyright GregFood; Mod version:"+gregfood.verNum+"; Last version:"+gregfood.newVerNum,this.width/2,this.height-40,16777215);
        ...
        protected void init() {
            ...
            this.addButton(new ButtonWidget(20,150,140,20, text, (buttonWidget) -> {
                try {
            ...
            this.addButton(new ButtonWidget(20,50,100,20, new TranslatableText("screen.advice"), (buttonWidget) -> {
                try {
            ...
            this.addButton(new ButtonWidget(20,70,100,20, new TranslatableText("screen.email"), (buttonWidget) -> {
                try {
            ...
            this.addButton(new ButtonWidget(20, this.height - 27, 150, 20, new TranslatableText("screen.announce"), (button) -> {
                if(this.client!=null)
    ...
    public static class AnnounceScreen extends Screen {
        ...
        protected void init() {
            ...
            this.addButton(new ButtonWidget(this.width / 2 + 5, this.height - 27, 150, 20, new TranslatableText("screen.update"), (button) -> {
                if(this.client!=null)
    ...
    public static class ForceUpdateScreen extends Screen {
        ...
        protected void init() {
            ...
            this.addButton(new ButtonWidget(this.width / 2 + 5, this.height - 27, 150, 20, new TranslatableText("screen.force.button"), (button) -> {
                try {
                    Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler "+"https://www.mcbbs.net/thread-1120123-1-1.html");
                } catch (IOException e) {
                    e.printStackTrace();
            ...
            this.addButton(new ButtonWidget(5, this.height - 27, 75, 15, new TranslatableText("screen.force.cancel"), (button) -> {
                if(this.client!=null)
                    this.client.openScreen(new TitleScreen());
            }));
        }
